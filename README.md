...
### Sketches
![PID_Gameboy_Image](https://github.com/lschenc41/PID_GameBoy/blob/master/PID_Gameboy_Image.PNG){:height="500" width="300"} ![PID_Gameboy_Sketch](https://github.com/lschenc41/PID_GameBoy/blob/master/PID_Gameboy_Sketch.PNG){:height="300px" width="600"}
### List of Materials
- Arduino
- Breadboard
- Motor
